...
class TAS_Prac4:
    def __init__(self, gram, funAL):
        ...
        self.TAS["Ep"]["-"] = Produccion("Ep", ["-", "T", "Ep"])
        self.TAS["Ep"][")"] = Produccion("Ep", ["EOS"])
        self.TAS["Ep"]["EOS"] = Produccion("Ep", ["EOS"])
        #T
        self.TAS["T"] = {}
        ...
        #Tp
        self.TAS["Tp"] = {}
        self.TAS["Tp"]["+"] = Produccion("Tp", ["EOS"])
        self.TAS["Tp"]["-"] = Produccion("Tp", ["EOS"])
        self.TAS["Tp"]["*"] = Produccion("Tp", ["*", "F", "Tp"])
        self.TAS["Tp"]["/"] = Produccion("Tp", ["/", "F", "Tp"])
        self.TAS["Tp"][")"] = Produccion("Tp", ["EOS"])
        self.TAS["Tp"]["EOS"] = Produccion("Tp", ["EOS"])
        #F
        self.TAS["F"] = {}
